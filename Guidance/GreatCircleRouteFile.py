...
class GreatCircleRoute(Graph):
    ...
    def computeGreatCircle(self, 
        ...
        '''
        distance_radians = 2 * math.asin(math.sqrt(math.pow((math.sin(old_div((self.ptlat1_radians-self.ptlat2_radians),2))),2) + math.cos(self.ptlat1_radians) * math.cos(self.ptlat2_radians)*math.pow((math.sin(old_div((self.ptlon1_radians-self.ptlon2_radians),2))),2)))
        ...
        while ( (endOfSimulation == False) and (overflownDistanceMeters <  distanceMeters)):
            ...
            fprime = old_div(overflownDistanceMeters, distanceMeters)
            ...
            A = old_div(math.sin((1-fprime)*distance_radians), math.sin(distance_radians))
            B = old_div(math.sin(fprime*distance_radians), math.sin(distance_radians))
