...
from FlightProfile.src.aerocalc.airspeed import cas2tas
...
from FlightProfile.src.Environment.RunWaysDatabaseFile import RunWayDataBase
from FlightProfile.src.Environment.WayPointsDatabaseFile import WayPointsDatabase

from FlightProfile.src.Guidance.GroundRunLegFile import GroundRunLeg
from FlightProfile.src.Guidance.DescentGlideSlopeFile import DescentGlideSlope

from FlightProfile.src.Guidance.BaseTurnLegFile import BaseTurnLeg
from FlightProfile.src.Guidance.WayPointFile import WayPoint
...
class TurnLeg(Graph):
    ...
    def buildTurnLeg(self, 
        ...
        radiusOfTurnMeters = old_div((tasMetersPerSecond * tasMetersPerSecond), (9.81 * math.tan(math.radians(bankAngleDegrees))))
        if ((2*radiusOfTurnMeters) > self.initialWayPoint.getDistanceMetersTo(self.finalWayPoint)):
            ...
            radiusOfTurnMeters = old_div((tasMetersPerSecond * tasMetersPerSecond), (9.81 * math.tan(math.radians(25.0))))
        ''' case of last turn '''
        if lastTurn == True:
        ...
        while ( (endOfSimulation == False) and (continueTurning == True)):
            ...
            deltaHeadingDegrees = math.degrees(math.atan(old_div(deltaDistanceMeters, radiusOfTurnMeters)))
