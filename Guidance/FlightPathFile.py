...
from FlightProfile.src.Guidance.FlightPlanFile import FlightPlan
from FlightProfile.src.Guidance.GroundRunLegFile import GroundRunLeg
from FlightProfile.src.Guidance.ClimbRampFile import ClimbRamp
from FlightProfile.src.Guidance.TurnLegFile import TurnLeg
from FlightProfile.src.Guidance.GreatCircleRouteFile import GreatCircleRoute
from FlightProfile.src.Guidance.DescentGlideSlopeFile import DescentGlideSlope
from FlightProfile.src.Guidance.WayPointFile import Airport
...
class FlightPath(FlightPlan):
    ...
    def getAircraft(self):
        ...
        if ( acBd.aircraftExists(self.aircraftICAOcode) and
            ...
            messagebox.showerror("Error", self.className + ': aircraft not found=' + self.aircraftICAOcode)
